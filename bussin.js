...
// /private/var/root/bussin/node_modules/delayed-stream/lib/delayed_stream.js
...
// /private/var/root/bussin/node_modules/combined-stream/lib/combined_stream.js
...
// /private/var/root/bussin/node_modules/mime-db/db.json
...
// /private/var/root/bussin/node_modules/mime-db/index.js
...
// /private/var/root/bussin/node_modules/mime-types/index.js
...
// /private/var/root/bussin/node_modules/asynckit/lib/defer.js
...
// /private/var/root/bussin/node_modules/asynckit/lib/async.js
...
// /private/var/root/bussin/node_modules/asynckit/lib/abort.js
...
// /private/var/root/bussin/node_modules/asynckit/lib/iterate.js
...
// /private/var/root/bussin/node_modules/asynckit/lib/state.js
...
// /private/var/root/bussin/node_modules/asynckit/lib/terminator.js
...
// /private/var/root/bussin/node_modules/asynckit/parallel.js
...
// /private/var/root/bussin/node_modules/asynckit/serialOrdered.js
...
// /private/var/root/bussin/node_modules/asynckit/serial.js
...
// /private/var/root/bussin/node_modules/asynckit/index.js
...
// /private/var/root/bussin/node_modules/form-data/lib/populate.js
...
// /private/var/root/bussin/node_modules/form-data/lib/form_data.js
...
// /private/var/root/bussin/node_modules/follow-redirects/debug.js
...
// /private/var/root/bussin/node_modules/follow-redirects/index.js
...
// /private/var/root/bussin/node_modules/geoip-lite/lib/utils.js
var require_utils = __commonJS((exports, module) => {
  var utils24 = module.exports = {};
  utils24.aton4 = function(a) {
    a = a.split(/\./);
    return (parseInt(a[0], 10) << 24 >>> 0) + (parseInt(a[1], 10) << 16 >>> 0) + (parseInt(a[2], 10) << 8 >>> 0) + (parseInt(a[3], 10) >>> 0);
  };
  utils24.aton6 = function(a) {
    a = a.replace(/"/g, "").split(/:/);
    var l = a.length - 1;
    var i;
    if (a[l] === "") {
  ...
  utils24.isPrivateIP = function(addr) {
    addr = addr.toString();
  ...
  utils24.ntoa4 = function(n) {
    n = n.toString();
    n = "" + (n >>> 24 & 255) + "." + (n >>> 16 & 255) + "." + (n >>> 8 & 255) + "." + (n & 255);
    return n;
  };
  utils24.ntoa6 = function(n) {
    var a = "[";
...
// /private/var/root/bussin/node_modules/geoip-lite/lib/fsWatcher.js
var require_fsWatcher = __commonJS((exports, module) => {
  var makeFsWatchFilter = function(name, directory, filename, cooldownDelay, callback) {
    var cooldownId = null;
  ...
  var stopWatching = function(name) {
...
// /private/var/root/bussin/node_modules/async/dist/async.js
var require_async2 = __commonJS((exports, module) => {
  (function(global2, factory) {
      ...
      return function(fns) {
        ...
        var go = initialParams(function(args2, callback) {
          ...
          return eachfn(fns, function(fn, cb) {
            wrapAsync2(fn).apply(that, args2.concat(cb));
          }, callback);
        });
        if (args.length) {
    ...
    function eachOfLimit(coll, limit, iteratee, callback) {
      _eachOfLimit(limit)(coll, wrapAsync2(iteratee), callback);
    }
    ...
    var eachOf = function(coll, iteratee, callback) {
      ...
      eachOfImplementation(coll, wrapAsync2(iteratee), callback);
    };
    function doParallel(fn) {
      return function(obj, iteratee, callback) {
        return fn(eachOf, obj, wrapAsync2(iteratee), callback);
      };
    }
    ...
    function doParallelLimit(fn) {
      return function(obj, limit, iteratee, callback) {
        return fn(_eachOfLimit(limit), obj, wrapAsync2(iteratee), callback);
      };
    }
    ...
    var auto = function(tasks, concurrency, callback) {
      ...
      function getDependents(taskName) {
        var result = [];
        baseForOwn(tasks, function(task, key) {
          if (isArray2(task) && baseIndexOf(task, taskName, 0) >= 0) {
            result.push(key);
          }
        });
        return result;
    ...
    function autoInject(tasks, callback) {
      ...
      baseForOwn(tasks, function(taskFn, key) {
        ...
        function newTask(results, taskCb) {
          ...
          newArgs.push(taskCb);
          wrapAsync2(taskFn).apply(null, newArgs);
        }
      });
    ...
    function queue(worker, concurrency, payload) {
      ...
      function _insert(data4, insertAtFront, callback) {
      ...
      var q = {
        ...
        started: false,
        paused: false,
        push: function(data4, callback) {
          _insert(data4, false, callback);
        },
        kill: function() {
          q.drain = noop2;
          q._tasks.empty();
        },
        unshift: function(data4, callback) {
          _insert(data4, true, callback);
        },
    ...
    function seq() {
      var _functions = arrayMap(arguments, wrapAsync2);
      return function() {
        var args = slice(arguments);
        var that = this;
    ...
    var constant = function() {
      var values4 = slice(arguments);
      var args = [null].concat(values4);
      return function() {
    ...
    function eachLimit(coll, iteratee, callback) {
      eachOf(coll, _withoutIndex(wrapAsync2(iteratee)), callback);
    }
    function eachLimit$1(coll, limit, iteratee, callback) {
      _eachOfLimit(limit)(coll, _withoutIndex(wrapAsync2(iteratee)), callback);
    }
    ...
    function _filter(eachfn, coll, iteratee, callback) {
      ...
      filter3(eachfn, coll, wrapAsync2(iteratee), callback || noop2);
    }
    ...
    function _parallel(eachfn, tasks, callback) {
      ...
      eachfn(tasks, function(task, key, callback2) {
        wrapAsync2(task)(function(err, result) {
          if (arguments.length > 2) {
            result = slice(arguments, 1);
          }
          results[key] = result;
    ...
    var priorityQueue = function(worker, concurrency) {
      ...
      q.push = function(data4, priority, callback) {
        if (callback == null)
          callback = noop2;
    ...
    function tryEach(tasks, callback) {
      ...
      eachSeries(tasks, function(task, callback2) {
        wrapAsync2(task)(function(err, res) {
          if (arguments.length > 2) {
            result = slice(arguments, 1);
          } else {
            result = res;
...
// /private/var/root/bussin/node_modules/geoip-lite/lib/geoip.js
var require_geoip = __commonJS((exports, module) => {
  var lookup4 = function(ip) {
    var fline = 0;
  ...
  var lookup6 = function(ip) {
    ...
    var line;
    var locId;
    if (utils24.cmp6(ip, cache6.lastIP) > 0 || utils24.cmp6(ip, cache6.firstIP) < 0) {
      return null;
    }
    do {
      line = Math.round((cline - fline) / 2) + fline;
      floor = readip(line, 0);
      ceil = readip(line, 1);
      if (utils24.cmp6(floor, ip) <= 0 && utils24.cmp6(ceil, ip) >= 0) {
      ...
      } else if (utils24.cmp6(floor, ip) > 0) {
        cline = line;
      } else if (utils24.cmp6(ceil, ip) < 0) {
        fline = line;
      }
    } while (1);
  };
  var get4mapped = function(ip) {
  ...
  var preload6 = function(callback) {
    var datFile;
    var datSize;
  ...
  var privateRange4 = [
    [utils24.aton4("10.0.0.0"), utils24.aton4("10.255.255.255")],
    [utils24.aton4("172.16.0.0"), utils24.aton4("172.31.255.255")],
    [utils24.aton4("192.168.0.0"), utils24.aton4("192.168.255.255")]
  ];
  var conf4 = {
    firstIP: null,
    lastIP: null,
  ...
  module.exports = {
    ...
    lookup: function(ip) {
      if (!ip) {
        ...
        return lookup4(utils24.aton4(ip));
      } else if (net.isIP(ip) === 6) {
        var ipv4 = get4mapped(ip);
        if (ipv4) {
          return lookup4(utils24.aton4(ipv4));
        } else {
          return lookup6(utils24.aton6(ip));
        }
      }
      return null;
    },
    pretty: function(n) {
      if (typeof n === "string") {
        ...
        return utils24.ntoa4(n);
      } else if (n instanceof Array) {
        return utils24.ntoa6(n);
      }
      return n;
    },
...
(function(TokenType2) {
  ...
  TokenType2[TokenType2["BinaryOperator"] = 9] = "BinaryOperator";
  TokenType2[TokenType2["Equals"] = 10] = "Equals";
  TokenType2[TokenType2["Comma"] = 11] = "Comma";
  TokenType2[TokenType2["Colon"] = 12] = "Colon";
  TokenType2[TokenType2["Semicolon"] = 13] = "Semicolon";
  TokenType2[TokenType2["Dot"] = 14] = "Dot";
  TokenType2[TokenType2["OpenParen"] = 15] = "OpenParen";
  TokenType2[TokenType2["CloseParen"] = 16] = "CloseParen";
  TokenType2[TokenType2["OpenBrace"] = 17] = "OpenBrace";
  TokenType2[TokenType2["CloseBrace"] = 18] = "CloseBrace";
  TokenType2[TokenType2["OpenBracket"] = 19] = "OpenBracket";
  TokenType2[TokenType2["CloseBracket"] = 20] = "CloseBracket";
  TokenType2[TokenType2["Quotation"] = 21] = "Quotation";
  TokenType2[TokenType2["Greater"] = 22] = "Greater";
  TokenType2[TokenType2["Lesser"] = 23] = "Lesser";
  TokenType2[TokenType2["EqualsCompare"] = 24] = "EqualsCompare";
  TokenType2[TokenType2["NotEqualsCompare"] = 25] = "NotEqualsCompare";
  TokenType2[TokenType2["Exclamation"] = 26] = "Exclamation";
  TokenType2[TokenType2["And"] = 27] = "And";
  TokenType2[TokenType2["Ampersand"] = 28] = "Ampersand";
  TokenType2[TokenType2["Bar"] = 29] = "Bar";
...
// utils/transcriber.ts
import {readFileSync} from "fs";

// /private/var/root/bussin/node_modules/axios/lib/helpers/bind.js
...
// /private/var/root/bussin/node_modules/axios/lib/utils.js
...
// /private/var/root/bussin/node_modules/axios/lib/core/AxiosError.js
...
// /private/var/root/bussin/node_modules/axios/lib/platform/node/classes/FormData.js
var import_form_data = __toESM(require_form_data(), 1);
var FormData_default = import_form_data.default;

// /private/var/root/bussin/node_modules/axios/lib/helpers/toFormData.js
...
// /private/var/root/bussin/node_modules/axios/lib/helpers/AxiosURLSearchParams.js
...
// /private/var/root/bussin/node_modules/axios/lib/helpers/buildURL.js
...
// /private/var/root/bussin/node_modules/axios/lib/core/InterceptorManager.js
...
// /private/var/root/bussin/node_modules/axios/lib/defaults/transitional.js
...
// /private/var/root/bussin/node_modules/axios/lib/platform/node/classes/URLSearchParams.js
import url from "url";
var URLSearchParams_default = url.URLSearchParams;

// /private/var/root/bussin/node_modules/axios/lib/platform/node/index.js
var node_default = {
  isNode: true,
  classes: {
...
// /private/var/root/bussin/node_modules/axios/lib/platform/common/utils.js
var exports_utils = {};
...
// /private/var/root/bussin/node_modules/axios/lib/platform/index.js
var platform_default = {
  ...exports_utils,
  ...node_default
};

// /private/var/root/bussin/node_modules/axios/lib/helpers/toURLEncodedForm.js
...
// /private/var/root/bussin/node_modules/axios/lib/helpers/formDataToJSON.js
...
// /private/var/root/bussin/node_modules/axios/lib/defaults/index.js
...
// /private/var/root/bussin/node_modules/axios/lib/helpers/parseHeaders.js
...
// /private/var/root/bussin/node_modules/axios/lib/core/AxiosHeaders.js
...
// /private/var/root/bussin/node_modules/axios/lib/core/transformData.js
...
// /private/var/root/bussin/node_modules/axios/lib/cancel/isCancel.js
function isCancel(value) {
  return !!(value && value.__CANCEL__);
}

// /private/var/root/bussin/node_modules/axios/lib/cancel/CanceledError.js
...
// /private/var/root/bussin/node_modules/axios/lib/core/settle.js
...
// /private/var/root/bussin/node_modules/axios/lib/helpers/isAbsoluteURL.js
function isAbsoluteURL(url2) {
  return /^([a-z][a-z\d+\-.]*:)?\/\//i.test(url2);
}

// /private/var/root/bussin/node_modules/axios/lib/helpers/combineURLs.js
function combineURLs(baseURL, relativeURL) {
  return relativeURL ? baseURL.replace(/\/+$/, "") + "/" + relativeURL.replace(/^\/+/, "") : baseURL;
}

// /private/var/root/bussin/node_modules/axios/lib/core/buildFullPath.js
...
// /private/var/root/bussin/node_modules/proxy-from-env/index.js
...
// /private/var/root/bussin/node_modules/axios/lib/adapters/http.js
...
// /private/var/root/bussin/node_modules/axios/lib/env/data.js
var VERSION = "1.6.1";

// /private/var/root/bussin/node_modules/axios/lib/helpers/parseProtocol.js
function parseProtocol(url2) {
  const match = /^([-+\w]{1,25})(:?\/\/|:)/.exec(url2);
  return match && match[1] || "";
}

// /private/var/root/bussin/node_modules/axios/lib/helpers/fromDataURI.js
...
// /private/var/root/bussin/node_modules/axios/lib/helpers/AxiosTransformStream.js
import stream from "stream";

// /private/var/root/bussin/node_modules/axios/lib/helpers/throttle.js
...
// /private/var/root/bussin/node_modules/axios/lib/helpers/speedometer.js
...
// /private/var/root/bussin/node_modules/axios/lib/helpers/formDataToStream.js
import {TextEncoder} from "util";
import {Readable} from "stream";

// /private/var/root/bussin/node_modules/axios/lib/helpers/readBlob.js
...
// /private/var/root/bussin/node_modules/axios/lib/helpers/ZlibHeaderTransformStream.js
...
// /private/var/root/bussin/node_modules/axios/lib/helpers/callbackify.js
...
// /private/var/root/bussin/node_modules/axios/lib/helpers/cookies.js
...
// /private/var/root/bussin/node_modules/axios/lib/helpers/isURLSameOrigin.js
...
// /private/var/root/bussin/node_modules/axios/lib/adapters/xhr.js
...
// /private/var/root/bussin/node_modules/axios/lib/adapters/adapters.js
var knownAdapters = {
  http: http_default,
  xhr: xhr_default
};
...
// /private/var/root/bussin/node_modules/axios/lib/core/dispatchRequest.js
...
// /private/var/root/bussin/node_modules/axios/lib/core/mergeConfig.js
...
// /private/var/root/bussin/node_modules/axios/lib/helpers/validator.js
...
// /private/var/root/bussin/node_modules/axios/lib/core/Axios.js
...
// /private/var/root/bussin/node_modules/axios/lib/cancel/CancelToken.js
class CancelToken {
...
// /private/var/root/bussin/node_modules/axios/lib/helpers/spread.js
...
// /private/var/root/bussin/node_modules/axios/lib/helpers/isAxiosError.js
function isAxiosError(payload) {
  return utils_default.isObject(payload) && payload.isAxiosError === true;
}

// /private/var/root/bussin/node_modules/axios/lib/helpers/HttpStatusCode.js
var HttpStatusCode = {
  Continue: 100,
...
// /private/var/root/bussin/node_modules/axios/lib/axios.js
...
async function get_currency() {
  ...
  const currency = currencies.find((el) => el.code === country);
  return currency.currency.symbol;
}
async function get_country() {
  const response = await axios_default.get("https://api64.ipify.org?format=json");
...
var geoip = require_geoip();
String.prototype.replace_fr = function(target, replacement) {
  const pattern = new RegExp('(?<![\'"`])\\b' + target + '\\b(?!["\'`])', "g");
  return this.replace(pattern, replacement);
};
var currencies = JSON.parse(readFileSync("./src/utils/currencies.json", "utf-8"));

// main.ts
async function run(filename) {
  const parser2 = new Parser;
  const env = createGlobalEnv();
  let input = readFileSync2(filename, "utf-8");
  if (filename.includes(".bsx"))
